...
@section('division_container')
    ...
    @if(  Session::has("academic_year_object")  and Session::has("term_object") and Session::has("class_level_object") and Session::has("school_object") and Session::has("class_subdivision_object") )
        ...
        @php
            ...
            $class_subdivision_object = Session::get("class_subdivision_object");
        ...
        <form action="{{ url('/schools_registration_excel_upload') }}"  class="col-6" method="POST"  enctype="multipart/form-data">
           ...
           <div class="row">
               ...
               <div class="col s4 l4 ">
                   Class Sub Division   :  {{  $class_subdivision_object->class_subdivision  }}
                   <input type="hidden"  class="class_subdivision_value" value="{{ $class_subdivision_object->id   }}}" name="class_subdivision_value"   />
               </div>
