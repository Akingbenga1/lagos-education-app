          ...
          <div id="profile-page-header" class="card gradient-shadow">
              ...
              <div class="card-content">
                  <div class="row">
                     ...
                     <h6 class="center-align"> {{$ThisUser['useremail']}}  </h6>
                  </div>
                  <div class="row">
                      <?php
              ...
              <div class="card-reveal">
                  ...
                  <div class="row">
                      <p>  <b> Surname:     </b>{{$ThisUser['surname']}} </p>
                      <p>  <b> Firstname:     </b> {{$ThisUser['firstname']}} </p>
                      <p>  <b> Middle name:   </b> {{$ThisUser['middlename']}} </p>
                         @if( !is_null( $ThisUser['student_relate']))
                          <p> <b> Student Admission Number:  </b>{{$ThisUser['student_relate']['school_admission_number']}} </p>
                      @endif

                      <p> <b> Primary Email Address: </b> {{$ThisUser['useremail']}}</p>
                      <p> <b> Date of Birth: </b> {{ date('d/m/Y', strtotime($ThisUser['date_of_birth']))  }}</p>
                      <p> <b> Gender:         </b>{{$ThisUser['sex']}}</p>
                  </div>
              </div>
          </div>
      </div>
