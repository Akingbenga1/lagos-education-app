...
function onAfter() {
 //jQuery(".main_title").delay(200).animate({left: '0px' }, 1000, 'easeOutBack');
 //jQuery(".subtitle").delay(200).animate({left: '0px' }, 1000, 'easeOutBack');
}
function onBefore() {
    //jQuery(".main_title, .subtitle").animate({left: '0px' }, 500);
} 
